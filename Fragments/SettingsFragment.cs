...
namespace Madamin.Unfollow.Fragments
{
        ...
        ISharedPreferencesOnSharedPreferenceChangeListener
    {
        ...
        public override void OnCreatePreferences(Bundle savedInstanceState, string rootKey)
        {
            ...
            // TODO: Remove when implimented
            FindPreference(PreferenceKeyUpdateCheck).Visible = false;
            FindPreference(PreferenceKeyTerms).Visible = false;
            FindPreference(PreferenceKeyDonate).Visible = false;
            FindPreference(PreferenceKeyAbout).Visible = false;
